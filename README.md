...
To use the OpenAI-based classifier, set your API key as an environment variable:
...
Alternatively, set `MODEL_TYPE = "dummy"` in `llm_event_classifier.py` to use the local rule-based classifier for testing.
